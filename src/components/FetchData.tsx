  ...
  export const FetchData: FC = () => {
    ...
    const onClick = useCallback(async () => {
      ...
      try {
        ...
        console.log(await program.account.dataAccount.fetch(data_account));

        let data = await program.account.dataAccount.fetch(data_account);

        let integer = data.integerdata;
        integer = Number(integer);
        console.log(integer);

        document.getElementById("fetch")!.innerHTML = integer.toString();
